...
TF.fit(X_train_shuffled, [t_train_shuffled[:,0:2],t_train_shuffled[:,2]],\
       batch_size=2000, epochs=10000, validation_split=0.05,callbacks=[es])

# Evaluating model
results = TF.evaluate(X_test,[t_test[:,0:2],t_test[:,2]])
...
# Save model
print("\nSaving ANN!")
saveout_filename = "ANN2_split_703_{}_n{}_{}_{}.h5".format(activation,n_neurons,n_neuronsA,n_neuronsB)
