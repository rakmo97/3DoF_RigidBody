...
x = layers.Dense(n_neurons, activation=activation,kernel_initializer='normal')(inputA)
# x = layers.Dense(n_neurons, activation=activation,kernel_initializer='normal')(x)
x = Model(inputs=inputA, outputs=x)

y = layers.Dense(n_neurons, activation=activation,kernel_initializer='normal')(x.output)
y = layers.Dense(n_neurons, activation=activation,kernel_initializer='normal')(y)
y = layers.Dense(2, activation='linear',kernel_initializer='normal')(y)

z = layers.Dense(n_neurons, activation=activation,kernel_initializer='normal')(x.output)
z = layers.Dense(n_neurons, activation=activation,kernel_initializer='normal')(z)
z = layers.Dense(n_neurons, activation='linear',kernel_initializer='normal')(z)
z = layers.Dense(1, activation='linear',kernel_initializer='normal')(z)
...
#Fit ANN
TF.fit(X_train_shuffled, [t_train_shuffled[:,0:2],t_train_shuffled[:,2]],\
       batch_size=100, epochs=10000, validation_split=0.05,callbacks=[es])
