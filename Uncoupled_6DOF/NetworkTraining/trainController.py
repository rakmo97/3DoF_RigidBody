...
history = TF.fit(X_train_shuffled, [t_train_shuffled[:,0:3],t_train_shuffled[:,3:6]], batch_size=10000, epochs=10000, validation_split=0.05,callbacks=[es])
...
saveout_filename = "ANN2_{}_n{}_nA{}_nB{}_specnorm.h5".format(activation,n_neurons,n_neuronsA,n_neuronsB)
