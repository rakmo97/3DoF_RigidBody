...
matfile = loadmat('E:/Research_Data/3DoF_RigidBody/Code_coupled_constmass/NetworkTraining/ANN2_data.mat')
...
# Save model
print("\nSaving ANN!")
saveout_filename = "E:/Research_Data/3DoF_RigidBody/Code_coupled_constmass/NetworkTraining/ANN2_703_{}_n{}.h5".format(activation,n_neurons)
