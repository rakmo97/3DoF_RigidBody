...
filename =  open('knn_save.pkl', 'rb') 
interp_list = pickle.load(filename)
interp = interp_list[0]
ctrlsOCLfull = interp_list[1]
trajsOCLfull = interp_list[2]
times_full = interp_list[3]
...
# for i in range(1):
    ...
    # for j in range(1):
        ...
        # Run sim
        times, states, Fapplied, beta = DSF.RunPolicyWithBetaInterpolatorSelf(x0,x_OCL,u_OCL,t_OCL,interp,beta)
